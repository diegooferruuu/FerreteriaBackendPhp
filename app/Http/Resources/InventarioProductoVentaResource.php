...
class InventarioProductoVentaResource extends JsonResource
{
    /**
...
//            'imagen2' => $this->producto->imagen,
            ...
            'precio' => $this->producto->precioGeneral->precio_menor,
            'descuento' => $this->producto->precioGeneral->descuento_menor,

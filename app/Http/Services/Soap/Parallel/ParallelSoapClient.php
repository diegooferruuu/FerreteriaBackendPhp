...
namespace App\Http\Services\Soap\Parallel;
 ...
 *
 * Implementacion soap con llamadas multiples usando el modulo curl.
 *
...
class ParallelSoapClient extends SoapClient implements LoggerAwareInterface
{
    ...
    /** @var array de todas las respuestas en el cliente */
    public $soapResponses = [];

    /** @var array de todas las solicitudes en el cliente */
    public $soapRequests = [];

    /** @var array de todas las solicitudes xml en el cliente */
    public $requestXmlArr = [];

    /** @var string de xml devuelto desde llamada soap */
    public $xmlResponse;

    /** @var string metodo actual */
    public $soapMethod;

    /** @var array de todos los metodos soap solicitados en el cliente */
    public $soapMethodArr = [];

    /** @var array de todos los ID de solicitudes */
    public $requestIds;

    /** @var string id de la ultima solicitud */
    public $lastRequestId;

    /** @var bool bandera soap paralelo */
    public $multi = false;

    /** @var bool log solicitud soap */
    public $logSoapRequest = false;

    /** @var array Encabezados predeterminados utilizados por la solicitud curl */
    ...
    /** @var array de todo el curl_info en el cliente */
    public $curlInfo = [];

    /** @var array de opciones curl */
    public $curlOptions = [];
     ...
     * @throws \Exception|\SoapFault|
     */
    public function getResponseResult(string $method, $args)
    {
        $this->soapMethod = static::GET_RESPONSE_CONST;
